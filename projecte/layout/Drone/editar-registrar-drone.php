<?php 
	...
	$sql= mysqli_query($link,"UPDATE dron SET `fecha_instalacion`='$fecha_editar', `modelo`='$modelo_editar', `calibracion`='$calibracion_editar', `observaciones`='$observaciones_editar' WHERE `id_dron`=$id_editar;");
